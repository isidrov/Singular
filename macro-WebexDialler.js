...
// Support up to 5 domains

const DIALPOSTFIX_WEBEXURL_1 = '@verizonone.webex.com';
const DIALPOSTFIX_WEBEXURL_2 = '@verizontwo.webex.com';




var DIALPOSTFIX_WEBEXURL = DIALPOSTFIX_WEBEXURL_1;  // Our default domain
...
function showSitesOptions(){
	
	 xapi.command("UserInterface Message Prompt Display", {
              Title: "Webex Sites"
            ,Text: "Please select your domain" 
            , FeedbackId: 'WEBX_SITE'
            , 'Option.1':DIALPOSTFIX_WEBEXURL_1
            , 'Option.2':DIALPOSTFIX_WEBEXURL_2
...
xapi.event.on('UserInterface Message Prompt Response', (event) => {
    ...
    switch(event.OptionId){
        ...
        case '1':
            DIALPOSTFIX_WEBEXURL = DIALPOSTFIX_WEBEXURL_1;
            break;
        case '2':
            DIALPOSTFIX_WEBEXURL = DIALPOSTFIX_WEBEXURL_2;
            break;
