...
# Form implementation generated from reading ui file 'Gnosis_v0.61.ui'
#
...
class Ui_Gnosis(object):
    def setupUi(self, Gnosis):
        ...
        self.pushButton_SQL_Exit = QtWidgets.QPushButton(self.widget_6)
        self.pushButton_SQL_Exit.setObjectName("pushButton_SQL_Exit")
        self.horizontalLayout_6.addWidget(self.pushButton_SQL_Exit)
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 954, 594))
        ...
        self.generic_VOS_QWidget.setGeometry(QtCore.QRect(0, 0, 849, 594))
    ...
    def retranslateUi(self, Gnosis):
        ...
        self.pushButton_SQL_Exit.setText(_translate("Gnosis", "Exit"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.generic_VOS_QWidget), _translate("Gnosis", "Generic VOS"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("Gnosis", "Spark"))
