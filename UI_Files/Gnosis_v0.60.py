...
# Form implementation generated from reading ui file 'Gnosis_v0.60.ui'
#
...
class Ui_Gnosis(object):
    def setupUi(self, Gnosis):
        ...
        self.generic_VOS_QWidget.setGeometry(QtCore.QRect(0, 0, 954, 594))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 954, 594))
    ...
    def retranslateUi(self, Gnosis):
        ...
        self.comboBox_product_vos_gen.setItemText(1, _translate("Gnosis", "CUC"))
        self.comboBox_product_vos_gen.setItemText(2, _translate("Gnosis", "CER"))
